...
const Banner = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      deskripsi: "dessert pencuci mulut paling manis dan lezat.",
      harga: 20000,
    ...
    },
    {
      ...
      deskripsi: "Puding coklat yang lumer luar dalam pudding.",
      harga: 30000,
      image: Pudding,
    },
    {
      id: 4,
      namaMakanan: "Coklat dubai",
      deskripsi: "Coklat viral di setiap gigitan memberikan kemewahan tersendiri di mulut anda.",
      harga: 5000,
      image: Coklat,
    },
  ];
