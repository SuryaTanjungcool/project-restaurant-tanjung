      ...
      <div style={BgStyle} className="py-14">
        <div className="container min-h-[580px] relative z-10">
          ...
          data-aos="fade-up"
            ...
            Kami menyediakan produk makanan yang sehat dan lezat dari mulai daging, sereal, dan sayuran. Semua makanan disini telah terverifikasi sehat dan bersih. Bila tidak bisa makan di tempat kami, kalian masih bisa untuk mencicipi makanan dengan cara pesan online. Makanan Anda akan siap hanya dengan menunggu di rumah. Jangan lupa makan di tempat kami!
            <br />
